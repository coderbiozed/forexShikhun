                    ...
                    <div class="my_pro_dash">
                        <div class="my_pro_det">
                            <div class="my_pro_lm">
                                ...
                                <div class="m_p_lo">
                                    <div class="cust_btn">
                                        <span class="fas fa-sign-out-alt c_blue"></span>
                                        <span class="u_p">Logout</span>
                                    </div>
                                </div>
                            </div>
                            <div class="my_pro_meta">
                                <div>
                                    <h4><span>Mahmud Shejan</span><span class="c_blue n_d">||</span><span class="my_pro_nic">@_shejan10</span></h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="my_pro_item">
                                                            ...
                                                            <input type="text" placeholder="Unique User Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="my_pro_item">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="my_pro_item">
                                                            <div class="my_pr_it_ti">
                                                                <h4>Password</h4>
                                                                <a data-bs-toggle="collapse" href="#mp_con_pas" role="button" aria-expanded="false" aria-controls="mp_con_pas">
                                                                    <div class="cust_btn"><i class="fa-solid fa-user-pen c_blue"></i></div>
                                                                </a>                                                      
                                                            </div>                                                  
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="my_pro_item">
                                                            ...
                                                            <textarea name="" id="" class="mpi_c_mt" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="" class="cust_btn my_pro_ch_btn">
                                                    Save changes
                                                </button>
                                            </form>
                                        </div>
